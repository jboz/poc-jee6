/*
 * Core JavaScript functionality for the application. Performs the required Restful calls, validates return values, and populates
 * the member table.
 */
...
/*
 * Attempts to register a new member using a JAX-RS POST. The callbacks the refresh the member table, or process JAX-RS response
 * codes to update the validation errors.
 */
function registerMember(formValues) {
	...
	$.post('rest/members', formValues, function(data) {
